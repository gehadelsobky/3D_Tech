export default {
  ...
  giftFinder: {
    ...
    approxResultsTitle: 'Closest Options',
    approxBadge: 'Close to your request',
    approxOverBudget: 'Above the budget you selected',
    approxSlowerDelivery: 'Lead time is longer than requested',
    noMatchTitle: "We couldn't find an exact match",
    noMatchText: 'Tell us what you need and our team will recommend the right products for your budget and timeline.',
    noMatchCta: 'Talk to us',
  ...
  login: {
    ...
    forgotSubtitle: 'Enter the email on your admin account and we will send you a reset link.',
    forgotEmail: 'Email',
    forgotEmailPlaceholder: 'you@company.com',
    forgotSubmit: 'Send reset link',
    forgotSending: 'Sending...',
    forgotSentTitle: 'Check your inbox',
    forgotSentText: 'If that email belongs to an admin account, a reset link is on its way. The link expires in {minutes} minutes.',
    // Reset password
    resetTitle: 'Choose a new password',
    resetFor: 'Resetting the password for {username}.',
    resetPassword: 'New password',
    resetPasswordPlaceholder: 'At least 8 characters',
    resetConfirm: 'Confirm new password',
    resetConfirmPlaceholder: 'Repeat the new password',
    resetSubmit: 'Set new password',
    resetSubmitting: 'Saving...',
    resetChecking: 'Checking your link...',
    resetInvalidTitle: 'This link is no longer valid',
    resetInvalidText: 'Reset links expire after {minutes} minutes and can only be used once. Request a new one.',
  ...
  productImport: {
    ...
    importActionOne: 'Import {count} product',
    ...
    doneOne: 'Imported {count} product.',
    rowLabel: 'Row',
    importAnother: 'Import another file',
    templateDownloadError: 'Could not download the template',
